...
/**
 * The agent is typed to OpenAI's chat options.  To use a different provider,
 * e.g. watsonx.ai or Anthropic, enable its starter dependency in pom.xml and its
 * credentials in application.properties, then replace OpenAiChatOptions.Builder
 * here (and where AiApplication creates it) with that provider's options builder,
 * e.g. WatsonxAiChatOptions.Builder or AnthropicChatOptions.Builder.
 */
@Configuration
