...
public final class AiAgentSession implements AiAgent<Object> {
    ...
    public static AiAgentSession create(AiAgent agent, CassandraChatMemory chatHistory) {
        return new AiAgentSession(agent, chatHistory);
    }

    AiAgentSession(AiAgent agent, CassandraChatMemory chatHistory) {
        this.agent = agent;
